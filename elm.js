...
var _user$project$Model$Card = F3(
	function (a, b, c) {
		return {id: a, state: b, group: c};
	});
var _user$project$Model$Model = function (a) {
	return {game: a};
};
var _user$project$Model$Matched = {ctor: 'Matched'};
var _user$project$Model$Closed = {ctor: 'Closed'};
var _user$project$Model$Open = {ctor: 'Open'};
var _user$project$Model$GameOver = {ctor: 'GameOver'};
var _user$project$Model$Matching = F2(
	function (a, b) {
		return {ctor: 'Matching', _0: a, _1: b};
	});
var _user$project$Model$Choosing = function (a) {
	return {ctor: 'Choosing', _0: a};
};
var _user$project$Model$RestartGame = {ctor: 'RestartGame'};
var _user$project$Model$DeckGenerated = function (a) {
	return {ctor: 'DeckGenerated', _0: a};
};
var _user$project$Model$CardClicked = function (a) {
	return {ctor: 'CardClicked', _0: a};
};
var _user$project$Model$B = {ctor: 'B'};
var _user$project$Model$A = {ctor: 'A'};

var _user$project$DeckGenerator$static = function () {
	var urls = {
		ctor: '::',
		_0: '1',
		_1: {
	...
	var groupA = A2(
		_elm_lang$core$List$map,
		function (url) {
			return {id: url, group: _user$project$Model$A, state: _user$project$Model$Closed};
		},
		urls);
	var groupB = A2(
		_elm_lang$core$List$map,
		function (url) {
			return {id: url, group: _user$project$Model$B, state: _user$project$Model$Closed};
		},
		urls);
	return _elm_lang$core$List$concat(
		{
...
var _user$project$DeckGenerator$random = _elm_community$random_extra$Random_List$shuffle(_user$project$DeckGenerator$static);

var _user$project$Main$init = {
	game: _user$project$Model$Choosing(_user$project$DeckGenerator$static)
};
var _user$project$Main$allMatched = function (deck) {
	return A2(
		_elm_lang$core$List$all,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c.state, _user$project$Model$Matched);
		},
		deck);
};
var _user$project$Main$isMatching = F2(
	function (c1, c2) {
		return _elm_lang$core$Native_Utils.eq(c1.id, c2.id) && (!_elm_lang$core$Native_Utils.eq(c1.group, c2.group));
	});
var _user$project$Main$closeUnmatched = function (deck) {
	return A2(
		_elm_lang$core$List$map,
		function (c) {
			return (!_elm_lang$core$Native_Utils.eq(c.state, _user$project$Model$Matched)) ? _elm_lang$core$Native_Utils.update(
				c,
				{state: _user$project$Model$Closed}) : c;
		},
		deck);
};
var _user$project$Main$setCard = F3(
	function (state, card, deck) {
		return A2(
			_elm_lang$core$List$map,
			function (c) {
				return (_elm_lang$core$Native_Utils.eq(c.id, card.id) && _elm_lang$core$Native_Utils.eq(c.group, card.group)) ? _elm_lang$core$Native_Utils.update(
					card,
					{state: state}) : c;
			},
			deck);
	});
var _user$project$Main$updateCardClick = F2(
	function (clickedCard, gameState) {
		var _p0 = gameState;
		switch (_p0.ctor) {
			case 'Choosing':
				var updatedDeck = A3(
					_user$project$Main$setCard,
					_user$project$Model$Open,
					clickedCard,
					_user$project$Main$closeUnmatched(_p0._0));
				return A2(_user$project$Model$Matching, updatedDeck, clickedCard);
			case 'Matching':
				var _p2 = _p0._1;
				var _p1 = _p0._0;
				var updatedDeck = A2(_user$project$Main$isMatching, clickedCard, _p2) ? A3(
					_user$project$Main$setCard,
					_user$project$Model$Matched,
					_p2,
					A3(_user$project$Main$setCard, _user$project$Model$Matched, clickedCard, _p1)) : A3(_user$project$Main$setCard, _user$project$Model$Open, clickedCard, _p1);
				return _user$project$Main$allMatched(updatedDeck) ? _user$project$Model$GameOver : _user$project$Model$Choosing(updatedDeck);
			default:
				return gameState;
		}
	});
		...
		switch (_p3.ctor) {
			case 'CardClicked':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							game: A2(_user$project$Main$updateCardClick, _p3._0, model.game)
						}),
			...
			case 'DeckGenerated':
				return {
					ctor: '_Tuple2',
					_0: {
						game: _user$project$Model$Choosing(_p3._0)
					},
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$cardStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
	...
	switch (_p4.ctor) {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$src(
							A2(
								...
								'/public/cats/',
								A2(_elm_lang$core$Basics_ops['++'], card.id, '.jpg'))),
						_1: {
							ctor: '::',
							_0: _user$project$Main$cardStyle,
							_1: {ctor: '[]'}
						}
					}
				},
				...
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Model$CardClicked(card)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('/public/cats/closed.png'),
							_1: {
								ctor: '::',
								_0: _user$project$Main$cardStyle,
								_1: {ctor: '[]'}
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('matched'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src(
							A2(
...
var _user$project$Main$boardStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '800px'},
		_1: {ctor: '[]'}
	});
var _user$project$Main$viewCards = function (cards) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Main$boardStyle,
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$Main$viewCard, cards));
};
var _user$project$Main$view = function (model) {
	var _p5 = model.game;
	switch (_p5.ctor) {
		case 'Choosing':
			return _user$project$Main$viewCards(_p5._0);
		case 'Matching':
			return _user$project$Main$viewCards(_p5._0);
		default:
			return A2(
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('restart'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$RestartGame),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			...
			_1: A2(_elm_lang$core$Random$generate, _user$project$Model$DeckGenerated, _user$project$DeckGenerator$random)
		},
